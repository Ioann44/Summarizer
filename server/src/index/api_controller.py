...
def summarize():
    ...
    compressed_text, info_msg = service.summarize(source_text, method_is_vec, compression_mul)
...
def get_text_obj(hash: str):
    ...
    if text_obj is None:
        ...
        return {
            key: value for key, value in text_obj.items() if key in "preview sourceFile lastModDate".split()
        }
